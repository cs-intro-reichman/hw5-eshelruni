...
public class Scrabble {
	...
	public static int wordScore(String word) {
		boolean runi = MyString.subsetOf("runi", word);
		boolean equal = word.length() == HAND_SIZE;
		int score = 0;
	...
	public static void testScrabbleScore() {
		System.out.println(wordScore("bee"));  // 15	
		System.out.println(wordScore("babe"));  // 32
		System.out.println(wordScore("friendship")); // 240
		System.out.println(wordScore("running")); // 1056
	}
